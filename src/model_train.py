...
if __name__ == "__main__":
    ...
    print('-' * 30, '\n')
    # scores[str(m)] = {}
    # scores[str(m)]['Accuracy_score'] = accuracy_score(y_test, y_pred)
    # scores[str(m)]['Precission_score'] = precision_score(y_test, y_pred)
    # scores[str(m)]['Precission_score'] = precision_score(y_test, y_pred)
    # scores[str(m)]['Recall_score'] = recall_score(y_test, y_pred)
    # scores[str(m)]['F1-score'] = f1_score(y_test, y_pred)
